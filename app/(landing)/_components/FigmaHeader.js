...
const FigmaHeader = () => {
  return (
    <header className="fixed top-5 left-1/2 transform -translate-x-1/2 z-50">
      <div className="flex w-full max-w-7xl h-auto px-6 py-3.5 flex-col items-start relative rounded-full border-2 border-black bg-red-600 shadow-[6px_6px_0_0_#000] backdrop-blur-md">
        <div className="flex w-full items-center justify-between relative">
          ...
          {/* Social Icons */}
          <div className="flex h-10 items-start gap-8">
            {/* TikTok Icon */}
            <svg className="w-9 h-9" width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* X (Twitter) Icon */}
            <svg className="w-7.5 h-7.5 fill-black" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
