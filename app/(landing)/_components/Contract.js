...
const Contract = () => {
  return (
    <section className="flex w-full px-24 py-24 flex-col items-start bg-gray-200">
      <div className="flex max-w-7xl px-12 pb-15 flex-col items-center gap-10 self-stretch relative mx-auto">
        {/* CONTRACT Heading */}
        <div className="flex flex-col items-start relative">
          <div className="text-white font-['Luckiest_Guy'] text-6xl font-normal leading-15 relative"
               style={{
        ...
        <div className="w-full max-w-5xl h-17 relative">
          {/* Background + Border (red dashed) */}
          <div className="w-full h-17 flex-shrink-0 rounded-3xl border-2 border-dashed border-black bg-red-600 absolute left-0 top-0"></div>
          
          {/* Background + Border (white solid) */}
          <div className="flex w-full h-17 p-0.5 justify-center items-center flex-shrink-0 rounded-3xl border-2 border-solid border-black bg-white absolute -left-2 -top-2">
            <div className="w-full h-16 flex-shrink-0 rounded-3xl bg-transparent shadow-[0_10px_15px_-3px_#374151,0_4px_6px_-4px_#374151] absolute left-0.5 top-0.5">
              
              {/* Input */}
              <div className="inline-flex h-16 px-4 py-4 items-center flex-shrink-0 rounded-3xl bg-gray-100 absolute left-0 top-0 w-full">
                <div className="w-full h-8 absolute left-4 top-4">
                  <div className="text-black font-['Stopbuck'] text-2xl font-medium leading-8 px-4">
              ...
              {/* Copy Button */}
              <button className="flex w-13 h-11 px-2.5 py-2.5 justify-center items-center flex-shrink-0 rounded-3xl border-2 border-solid border-red-600 bg-white shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] absolute right-1 top-2.5">
                <svg className="w-6 h-6 flex-shrink-0 absolute left-3.5 top-2.5" width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
